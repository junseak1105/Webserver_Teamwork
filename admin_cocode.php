...
<body>
    <div class="admin_cocode">
        <div class="admin_cocode_searchbox">
        ...
        <div class="admin_cocode_paper">
            <p>
                <?php
                    /* paging : 이전 페이지 */
                    if($page <= 1){
                ?>
                <a href="admin_cocode.php?page=1">이전</a>
                <?php } else{ ?>
                    <a href="admin_cocode.php?page=<?php echo ($page-1); ?>">이전</a>
                <?php };?>
                ...
                ?>
                    <a href="admin_cocode.php?page=<?php echo $print_page; ?>"><?php echo $print_page; ?></a>
                <?php };?>
                ...
                <?php
                    ...
                    if($page >= $total_page){
                ?>
                    <a href="admin_cocode.php?page=<?php echo $total_page; ?>">다음</a>
                <?php } else{ ?>
                    <a href="admin_cocode.php?page=<?php echo ($page+1); ?>">다음</a>
                <?php };?>
            </p>
        </div>
    </div>
