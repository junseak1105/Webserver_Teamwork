...
$query = "SELECT  count(*) as count  FROM recommend, post where recommend.title = post.title and recommend.userID = '$userID'";
...
$sql = "SELECT * FROM recommend, post where recommend.title = post.title and recommend.userID = '$userID'";
